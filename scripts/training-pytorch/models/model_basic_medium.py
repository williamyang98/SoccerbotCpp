...
# create model
class SoccerBotModel_Basic_Medium(nn.Module):
    DOWNSCALE_RATIO = 2
    BATCH_SIZE = 64
    STEPS_PER_EPOCH = 40
    ...
    def __init__(self):
        ...
        self.conv_0 = nn.Conv2d(3, 32, (3,3))
        self.act_0 = nn.LeakyReLU()
        self.pool_0 = nn.MaxPool2d((2,2))

        self.conv_1 = nn.Conv2d(32, 32, (3,3))
